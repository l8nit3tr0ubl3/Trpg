...
lake, left or right?""",
         """Passing the lake you come to a crack in a wall, large
enough to fit through.""",
         """You fall out the crack, down a large rift. It runs
left to right""",
         "The rift continues to the left.",
...
right is available.""",
         ...
         """The alley ends, and opens up into a town circle. What
once was a large statue is nothing but rubble.""",
         """There is a man with a large sword in your path,
scanning quickly, you see a small crevace beneath a building to
your right.""",
         "Crawling beneath the building, only forward is possible",
         "You begin to see light ahead of you.",
         """Sliding slowly out from the building, you see a field
in front of you""",
         ""]
